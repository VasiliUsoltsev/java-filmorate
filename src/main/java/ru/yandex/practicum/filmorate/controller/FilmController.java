...
import ru.yandex.practicum.filmorate.exception.IllegalArgumentFilmorateException;
...
public class FilmController {
    ...
    public Collection<Film> getPopularFilm(@RequestParam(defaultValue = "10") Long count) {
        if (count <= 0) {
            throw new IllegalArgumentFilmorateException("Недопустимое значение параметра", count);
        }
